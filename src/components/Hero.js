    ...
    <div className='bg-discord_blue pb-8 md:pb-0'>
      <div className='p-7 py-9 h-screen md:h-83vh md:flex relative'>
        <div className='flex flex-col gap-7 md:max-w-md lg:max-w-none lg:justify-center'>
          ...
          <h2 className='text-white text-lg font- tracking-wide lg:max-w-3xl'>IMAGINE A PLACE where you can belong to a school club, a gaming group, or a worldwide art community. Where just you and a handful of friends can spend time together. A place that makes it easy to talk every day and hang out more often.</h2>
